...
# Gadiformes = 10313
# Gobiiformes  = 1517500
# Pleuronectiformes  = 10331
```{r}
# IF ONLY ONE TAXON GROUP IS DESIRED
spec <- occurrence(taxonid = 10313, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923, 
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Coelorinchus_cutoff_pn1335_bgn1335_v02.0.tif")
eco2 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Cynoglossus_cutoff_pn1130_bgn1130_v02.0.tif")
eco3 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Eviota_cutoff_pn77_bgn100_v02.0.tif")
eco4 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Glossogobius_cutoff_pn25_bgn100_v02.0.tif")
eco5 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Malacocephalus_cutoff_pn723_bgn723_v02.0.tif")
eco6 <- raster("./data/reg/eco/bfish_demersal/demfish_sdm/v02/bfish_demersal_demfish_sdm_Citharus_cutoff_pn399_bgn399_v02.0.tif")
