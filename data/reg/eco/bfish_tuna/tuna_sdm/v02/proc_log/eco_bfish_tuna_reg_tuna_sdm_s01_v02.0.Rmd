...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "bfish_tuna"   #check
name1 <- "tuna_sdm"   #check
name2 <- "" #check
...
spec <- occurrence(taxonid = 267118, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923, 
...
```{r}
base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Katsuwonus_pelamis_cutoff_pn917_bgn917_v02.0.tif")
eco2 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Scomberomorus_commerson_cutoff_pn88_bgn100_v02.0.tif")
eco3 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Thunnus_alalunga_cutoff_pn162_bgn162_v02.0.tif")
eco4 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Thunnus_albacares_cutoff_pn1552_bgn1552_v02.0.tif")
eco5 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Thunnus_obesus_cutoff_pn1019_bgn1019_v02.0.tif")
eco6 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v02/bfish_tuna_tuna_sdm_Auxis_thazard_cutoff_pn434_bgn434_v02.0.tif")
