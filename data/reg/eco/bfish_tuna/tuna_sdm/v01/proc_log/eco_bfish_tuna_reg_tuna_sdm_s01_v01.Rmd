...
spec <- occurrence(#taxonid = 125539, 
...
map_leaflet(spec)
```
"Thunnus alalunga"   "Thunnus albacares"  "Thunnus maccoyii"   "Thunnus obesus"     "Thunnus orientalis"
[7] "Thunnus thynnus"    "Thunnus tonggol" 
```{r}
...
```{r}
base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v01/bfish_tuna_tuna_sdm_Katsuwonus_pelamis_v01.0.tif")
eco2 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v01/bfish_tuna_tuna_sdm_Thunnus_alalunga_v01.0.tif")
eco3 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v01/bfish_tuna_tuna_sdm_Thunnus_albacares_v01.0.tif")
eco4 <- raster("./data/reg/eco/bfish_tuna/tuna_sdm/v01/bfish_tuna_tuna_sdm_Thunnus_obesus_v01.0.tif")
...
eco <- eco1+eco2 # Excluded Thunnus albacares and obesus because the distribution is similar to alalunga
product1 <- eco
