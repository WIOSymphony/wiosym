...
(sourcesym <-  read_tsv(paste(dest_path, "eco_ch_shore_shoreline_proportion_norm01_1km_v01.0.tif_sourcesym.txt", sep="")))
```
...
shore_1km <- raster(paste(dest_path, "eco_ch_shore_shoreline_proportion_norm01_1km_v01.0.tif", sep=""))
plot(shore_1km)
```
...
```{r}
shore_temp <- shore_1km * temp_1km * 100
plot(shore_temp)
shore_trop <- shore_1km * trop_1km * 100
plot(shore_trop)
```
...
```{r}
export_object1 <- shore_temp
export_object2 <- shore_trop

dir(dest_path)
product_1 <- "shorehab_temp_relative_1km_v01.0.tif" 
product_2 <- "shorehab_trop_relative_1km_v01.0.tif"  # example
