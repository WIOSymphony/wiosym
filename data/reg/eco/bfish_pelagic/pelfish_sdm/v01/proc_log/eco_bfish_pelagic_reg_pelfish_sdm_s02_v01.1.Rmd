...
spec <- occurrence(taxonid = 125464,
                   #scientificname = "",
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_pelagic/pelfish_sdm/v01/bfish_pelagic_pelfish_sdm_Clupeidae_all_v01.0.tif")
eco2 <- raster("./data/reg/eco/bfish_pelagic/pelfish_sdm/v01/bfish_pelagic_pelfish_sdm_Engraulidae_CR_v01.0.tif")
