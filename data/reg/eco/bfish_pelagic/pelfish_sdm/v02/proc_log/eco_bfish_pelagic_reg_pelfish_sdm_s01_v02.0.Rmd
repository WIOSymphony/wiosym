...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "bfish_pelagic"   #check
name1 <- "pelfish_sdm"   #check
name2 <- "" #check
...
spec <- occurrence(taxonid = 125465,
                   #scientificname = "",
...
prod_cut <- product1
(dest_temp <- paste0(dest1_path, "/", subtheme1, "_", name1, "_", tax_name, "_cutoff_pn", pn, "_bgn", bgn, "_", version, d_version, ".tif"))
...
product1[is.na(grid_1km)==TRUE] <- NA
prod_nocut <- product1
(dest_temp <- paste0(dest1_path, "/", subtheme1, "_", name1, "_", tax_name, "_nocutoff_pn", pn, "_bgn", bgn, "_", version, d_version, ".tif"))
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_pelagic/pelfish_sdm/v02/bfish_pelagic_pelfish_sdm_Sardinella_cutoff_pn689_bgn689_v02.0.tif")
eco2 <- raster("./data/reg/eco/bfish_pelagic/pelfish_sdm/v02/bfish_pelagic_pelfish_sdm_Stolephorus_cutoff_pn135_bgn135_v02.0.tif")
eco3 <- raster("./data/reg/eco/bfish_pelagic/pelfish_sdm/v02/bfish_pelagic_pelfish_sdm_Thryssa_cutoff_pn75_bgn100_v02.0.tif")
