...
TrainClasses <- df  %>% 
  ...
  path_name <- paste(work_path, components[i], "_gbm_mod_allpred", sep="")
...
path_name <- paste(work_path, model, "_gbm_mod_allpred.tif", sep="")

coral <- raster(path_name)
...
coral_fill_path <- path <- paste(work_path, "coral_model_fill.tif", sep="")
...
writeRaster(coral_1km , paste(work_path, "coral_1km_sayamodel_percent.tif", sep=""), overwrite=F, COMPRESS=LZW)

coral_1km <- raster(paste(work_path, "coral_1km_sayamodel_percent.tif", sep=""))
...
seagrass_fill_path <- path <- paste(work_path, "seagrass_model_fill.tif", sep="")
...
writeRaster(seagrass_1km , paste(work_path, "seagrass_1km_sayamodel_percent_crop_lzw.tif", sep=""), overwrite=F, COMPRESS=LZW)

r <- raster(paste(work_path, "seagrass_1km_sayamodel_percent_crop_lzw.tif", sep=""))
...
writeRaster(seagrass_1km , paste(work_path, "seagrass_1km_sayamodel_percent.tif", sep=""), overwrite=F, COMPRESS=LZW)

seagrass_1km <- raster(paste(work_path, "seagrass_1km_sayamodel_percent.tif", sep=""))
