...
writeRaster(grid_250m_na, paste(work_path, "grid_250m_coral_combined_3.tif", sep= ""), overwrite=T, COMPRESS=LZW)

coral_250m_combined <- paste(work_path, "grid_250m_coral_combined_3.tif", sep= "")
...
crs(r) <- crs(grid_250m)
path <- paste(work_path, "grid_250m_coral_combined_3_lzw.tif", sep= "")
...
habitat_footprint_250m_path <- output_path <- paste(work_path, "grid_250m_habitat_footprint_combined_3.tif", sep= "")
writeRaster(grid_250m_na, output_path, overwrite=T, COMPRESS=LZW)
...
crs(r) <- crs(grid_250m)
habitat_footprint_250m_path <- path <- paste(work_path, "grid_250m_habitat_footprint_combined_3_lzw.tif", sep= "")
writeRaster(r, path,  overwrite=T, COMPRESS=LZW, datatype = 'INT4S')
...
path_comb <- paste(work_path, "grid_1km_coral_combined_3_proportion250m.tif", sep= "")
...
path_adj <- paste(work_path, "grid_1km_coral_combined_3_proportion250m_adj.tif", sep= "")
...
writeRaster(combined_footprint_250m_agg1km, paste(work_path, "grid_1km_mapfootprint_3_proportion250m.tif", sep= ""),  overwrite=T, COMPRESS=LZW)

combined_footprint_250m_agg1km <- raster(paste(work_path, "grid_1km_mapfootprint_3_proportion250m.tif", sep= ""))
...
writeRaster(r3, paste(work_path, "grid_1km_coral_combined_3_proportion250m_footprintadjusted.tif", sep= ""),  overwrite=T, COMPRESS=LZW)

footprint_1km <- raster(paste(work_path, "grid_1km_coral_combined_3_proportion250m_footprintadjusted.tif", sep= ""))
