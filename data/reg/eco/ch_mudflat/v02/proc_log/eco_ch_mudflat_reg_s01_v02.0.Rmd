...
# ========================================================================================================= #
## Brief description: 
tidal flats / mud flats from 30m resolution global dataset of tidal flats, divided into temperate and tropical zone
### Sripts/processes that needs to be updated prior?: eco_ch_mudflat_reg_s01_v01.1.Rmd (or simply ingest the existing mudflat_v01.tif listed in data sources below, "data6")
###
...
```{r}
data_sourcesym_num <-  6 # set total number of data files (e.g. <- 2), to help in export section
```
...
writeRaster(tidal_agg_1km, paste(work_path, "tidal_1km_0-100_2002-2016_v02.tif", sep=""), overwrite=T, COMPRESS=LZW)


# combine v01 and v02 tidal flats layers - they both are missing data but in different areas, due to problems wih high resolution mosaic conversions from Murray 30m dataset
