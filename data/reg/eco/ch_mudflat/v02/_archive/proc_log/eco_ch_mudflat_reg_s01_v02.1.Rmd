...
tidal_250m_masked <- tidal_250m*r
...
writeRaster(r_diff_agg_1km, paste(work_path, "r_diff_tidal_1km_v02_mask30m.tif", sep=""), overwrite=T, COMPRESS=LZW)
...
plot(tidal_agg_1km)
writeRaster(tidal_agg_1km, paste(work_path, "tidal_1km_0-100_2002-2016_v02_mask30m.tif", sep=""), overwrite=T, COMPRESS=LZW)
...
writeRaster(tidal_agg_1km_v01, paste(work_path, "tidal_1km_0-100_2002-2016_v01_mask30m.tif", sep=""), overwrite=T, COMPRESS=LZW)
