...
data4_sourcesym <- read_tsv(paste(data_dir, "bathymetry_mean_m_1km_v01.1.tif", "_sourcesym.txt", sep=""))
...
data5_sourcesym <- read_tsv(paste(data_dir, data_file2, "_sourcesym.txt", sep=""))
...
writeRaster(m_sum_1km , paste(work_path, "m_sum_focalfill_1km_lzw.tif", sep=""), overwrite=T, COMPRESS=LZW)
...
#```{r}
LP_1km <- raster(paste(work_path, "LP_1km.tif", sep=""))
...
product_norm0100 <- r_norm_0100 # input and check your object to be written to file
