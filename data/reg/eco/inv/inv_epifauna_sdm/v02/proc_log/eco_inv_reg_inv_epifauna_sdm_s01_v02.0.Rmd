...
spec <- occurrence(taxonid = 11718, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923, 
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Chaceon_cutoff_pn241_bgn241_v02.0.tif")
eco2 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Enteroctopus_cutoff_pn262_bgn262_v02.0.tif")
eco3 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Linckia_cutoff_pn68_bgn100_v02.0.tif")
eco4 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Mursia_cutoff_pn533_bgn533_v02.0.tif")
eco5 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Parvulastra_cutoff_pn17_bgn100_v02.0.tif")
eco6 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v02/inv_inv_epifauna_sdm_Octopus_cutoff_pn203_bgn203_v02.0.tif")
