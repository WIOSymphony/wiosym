...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "bfish_deep"   #check
name1 <- "deepfishsquid_sdm"   #check
name2 <- "" #check
...
# Decapodiformes = 325342
# Myctophiformes = 10309
# Lophiiformes = 10316
```{r}
# IF ONLY ONE TAXON GROUP IS DESIRED
spec <- occurrence(taxonid = 10316, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923, 
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Diaphus_cutoff_pn296_bgn296_v02.0.tif")
eco2 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Lampanyctodes_cutoff_pn393_bgn393_v02.0.tif")
eco3 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Lophius_cutoff_pn1385_bgn1385_v02.0.tif")
eco4 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Sepia_cutoff_pn1599_bgn1599_v02.0.tif")
eco5 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Todaropsis_cutoff_pn1328_bgn1328_v02.0.tif")
eco6 <- raster("./data/reg/eco/bfish_deep/deepfishsquid_sdm/v02/bfish_deep_deepfishsquid_sdm_Dibranchus_cutoff_pn238_bgn238_v02.0.tif")

eco <- eco1+eco2+eco3+eco4+eco5+eco6
product1 <- eco
