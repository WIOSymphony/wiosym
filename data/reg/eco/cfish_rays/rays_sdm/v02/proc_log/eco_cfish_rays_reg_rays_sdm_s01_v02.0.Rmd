...
# Batoidea = 368409
# Myliobatiformes = 196069
# Rajiformes = 10216
# Rhinopristiformes = 1042840
# Torpediniformes = 10215
```{r}
...
```{r}
# Ensemble model
e1 <- ensemble(m1,newdata=preds,filename='e1.tif',setting=list(method='weighted',stat='TSS'), overwrite=T, nc=11)
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Acroteriobatus_cutoff_v02.0.tif")
eco2 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Dasyatis_cutoff_v02.0.tif")
eco3 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Leucoraja_cutoff_v02.0.tif")
eco4 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Mobula_cutoff_v02.0.tif")
eco5 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Myliobatis_cutoff_v02.0.tif")
eco6 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Raja_cutoff_v02.0.tif")
eco7 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Rhinobatos_cutoff_v02.0.tif")
eco8 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Tetronarce_cutoff_v02.0.tif")
eco9 <- raster("./data/reg/eco/cfish_rays/rays_sdm/v02/cfish_rays_rays_sdm_Torpedo_cutoff_v02.0.tif")
