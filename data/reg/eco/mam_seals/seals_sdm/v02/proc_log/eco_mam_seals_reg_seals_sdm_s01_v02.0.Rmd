...
```{r}
tax_name <- 'Arctocephalus gazella'
```
...
```{r}
eco1 <- raster("./data/reg/eco/mam_seals/seals_sdm/v02/mam_seals_seals_sdm_Arctocephalus_gazella_cutoff_pn532_bgn532_v02.0.tif")
eco2 <- raster("./data/reg/eco/mam_seals/seals_sdm/v02/mam_seals_seals_sdm_Arctocephalus_pusillus_cutoff_pn90_bgn100_v02.0.tif")
