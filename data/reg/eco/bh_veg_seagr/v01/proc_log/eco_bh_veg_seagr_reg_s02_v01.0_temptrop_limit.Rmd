...
seagrass_1km <- raster(paste(dest_path, "seagrass_bed_proportion_1km_v01.0.tif", sep=""))
plot(seagrass_1km)
```
...
dir(dest_path)
product_1 <- "seagrass_bed_temp_percent_1km_v01.0.tif" 
product_2 <- "seagrass_bed_trop_percent_1km_v01.0.tif"  # example
