...
# ABOUT
# ========================================================================================================= #
## Brief description:  Seagrass map  combining multiple sources mapping presence of seagrass at 250m resolution then proportion at 1km, similar to mangrove and coral process. In addition to this script a predictive model was devloped for Saya Del Mahla Banks, then integrated here. Seagrasses combine many kinds of data inclduing different kind of models and maps. The main dataset to calibrate the data against have been the Allen Coral Atlas since it represents the biggest high resolution mapping effort in the WIO region.

###Needs updating with temperate/tropical to be completed
eco_bh_veg_seagr_reg_s02_v02.1_temptrop_limit.Rmd
### Scripts/processes that needs to be updated prior?: 
env_topo_reg_s01_v02.0.Rmd, eco_bh_reg_s01_model_seagrass_02.1.Rmd
###
### Script by: 
gk, sgu, R 4.1.1
### Updated: 
...
```{r}
(img_path <- paste(dest_path, descriptive_name, "_", unit, scale, "_", version, d_version, ".png", sep="" ))
prod1_scale <- seagrass_1km
