...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "mam_dolph"   #check
name1 <- "dolphin_sdm"   #check
name2 <- "" #check
...
```{r}
tax_name <- 'Globicephala macrorhynchus'
```
...
spec <- occurrence(taxonid = 136980,
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/mam_dolph/dolphin_sdm/v02/mam_dolph_dolphin_sdm_Globicephala_macrorhynchus_cutoff_pn39_bgn100_v02.0.tif")
eco2 <- raster("./data/reg/eco/mam_dolph/dolphin_sdm/v02/mam_dolph_dolphin_sdm_Grampus_griseus_cutoff_pn104_bgn104_v02.0.tif")
eco3 <- raster("./data/reg/eco/mam_dolph/dolphin_sdm/v02/mam_dolph_dolphin_sdm_Stenella_longirostris_cutoff_pn297_bgn297_v02.0.tif")
eco4 <- raster("./data/reg/eco/mam_dolph/dolphin_sdm/v02/mam_dolph_dolphin_sdm_Tursiops_aduncus_cutoff_pn120_bgn120_v02.0.tif")
eco5 <- raster("./data/reg/eco/mam_dolph/dolphin_sdm/v02/mam_dolph_dolphin_sdm_Tursiops_truncatus_cutoff_pn231_bgn231_v02.0.tif")

eco <- eco1+eco2+eco3+eco4+eco5
product1 <- eco

# Remove bottom 75% of points to give only high probability hotspots 
