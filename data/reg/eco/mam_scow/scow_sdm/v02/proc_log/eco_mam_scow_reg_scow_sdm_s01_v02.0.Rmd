...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "mam_scow"   #check
name1 <- "scow_sdm"   #check
name2 <- "" #check
...
spec <- occurrence(taxonid = 159502, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923, 
...
pex <- c("coast_distance_km", "coral_distance_km")
...
d
m1 <- sdm(Occurrence~.,data=d,methods=c('brt','svm'), n = 10)
m1
