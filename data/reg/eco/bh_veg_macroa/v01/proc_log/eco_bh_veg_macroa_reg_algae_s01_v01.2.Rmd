...
algae_temp_1km_path <- output_path1 <- paste(work_path, "algae_comb_temp_percent_grid_1km.tif", sep= "")
algae_trop_1km_path <- output_path2 <- paste(work_path, "algae_comb_trop_percent_grid_1km.tif", sep= "")
...
(product_orig1_path <- paste(dest_path, descriptive_name, "_", unit, "_temp_", scale, "_", version, d_version, ".tif", sep="" ))
(product_orig2_path <- paste(dest_path, descriptive_name, "_", unit, "_trop_", scale, "_", version, d_version, ".tif", sep="" ))
