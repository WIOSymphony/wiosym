...
# INRASTER TO FIX
```{r}
data4_dir <- data_dir <-  "./data/reg/pres/nrg_light/v01/proc/nrg_light/"  # input your data directory
dir(data_dir)
data4_file <- data_file <- "VNL_v2_2020_median_1kmResample_n_clip_reg_t1.tif" # your data file
data4_path <- paste(data4_dir, data_file, sep="")
data_dir <-  "./data/reg/pres/nrg_light/v01/"
data_outpath <- paste(data4_dir, "light_pollution_nighsat_v01.0_qc.tif", sep="")
