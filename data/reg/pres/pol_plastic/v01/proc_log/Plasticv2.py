# -*- coding: utf-8 -*-
"""
Generated by ArcGIS ModelBuilder on : 2022-09-09 10:06:07
"""
import arcpy
...
def Plastic():  # Plastic
    ...
    with arcpy.EnvManager(scratchWorkspace=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\pres\pol_plastic\v01\proc\plastic\Default.gdb", workspace=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\pres\pol_plastic\v01\proc\plastic\Default.gdb"):
        ...
        proc = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc"
        v1_flow_acc_pres_norm_int1_tif = arcpy.Raster("v1_flow_acc_pres_norm_int1.tif")
        Meijer2021_midpoint_emission_clip_wiosym_area = "Meijer2021_midpoint_emission_clip_wiosym_area"
        v01 = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01"

        # Process: Focal Statistics (2) (Focal Statistics) (sa)
        current_focal_plastic_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\current__focal_plastic.tif"
        ...
        current_norm_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\current_norm.tif"
        ...
        plastic_density_X10_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_density_X10.tif"
        ...
        plastic_density_combine_grid_focal_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_density_combine_grid_focal.tif"
        ...
        Plastic_density_landbase_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\Plastic_density_landbase.tif"
        ...
        plastic_density_combine_grid_log10_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_density_combine_grid_log10.tif"
        ...
        Plastic_lb_norm_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\Plastic_lb_norm.tif"
        ...
        plastic_relative_weighted_current_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_relative_weighted_current.tif"
        ...
        Plastic_relative_norm_v01_0_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\Plastic_relative_norm_v01.0.tif"
        ...
        plastic_amount_raster_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_amount_raster.tif"
        with arcpy.EnvManager(cellSize=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\grid\grid\v01\grid_1km_v01.1.tif", outputCoordinateSystem="PROJCS["WGS_1984_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cylindrical_Equal_Area"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",12.0],PARAMETER["standard_parallel_1",-12.0],UNIT["Meter",1.0]]", scratchWorkspace=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\pres\pol_plastic\v01\proc\plastic\Default.gdb", 
                              snapRaster="grid_1km_v01.1.tif", workspace=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\pres\pol_plastic\v01\proc\plastic\Default.gdb"):
            arcpy.conversion.PointToRaster(in_features="", value_field="dots_exten", out_rasterdataset=plastic_amount_raster_tif, cell_assignment="MOST_FREQUENT", priority_field="dots_exten", cellsize="\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\grid\\grid\\v01\\grid_1km_v01.1.tif", build_rat="BUILD")

        # Process: Focal Statistics (3) (Focal Statistics) (ia)
        plastic_focal_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_focal.tif"
        Focal_Statistics_3_ = plastic_focal_tif
        plastic_focal_tif = arcpy.ia.FocalStatistics(in_raster=plastic_amount_raster_tif, neighborhood="Circle 5 CELL", statistics_type="STD", ignore_nodata="DATA", percentile_value=90)
        plastic_focal_tif.save(Focal_Statistics_3_)


        # Process: Project (Project) (management)
        plastic_point_metric_ton_y_shp = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_point_metric_ton_y.shp"
        arcpy.management.Project(in_dataset=Meijer2021_midpoint_emission_clip_wiosym_area, out_dataset=plastic_point_metric_ton_y_shp, out_coor_system="PROJCS[\"WGS_1984_Cylindrical_Equal_Area\",GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137.0,298.257223563]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Cylindrical_Equal_Area\"],PARAMETER[\"false_easting\",0.0],PARAMETER[\"false_northing\",0.0],PARAMETER[\"central_meridian\",12.0],PARAMETER[\"standard_parallel_1\",-12.0],UNIT[\"Meter\",1.0]]", transform_method=[], in_coor_system="GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137.0,298.257223563]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433]]", preserve_shape="NO_PRESERVE_SHAPE", max_deviation="", vertical="NO_VERTICAL")

        # Process: Point to Raster (2) (Point to Raster) (conversion)
        Meijer2021_midpoint_emission_clip_wiosym_area_reproj_PointToRaster = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic\\Default.gdb\\Meijer2021_midpoint_emission_clip_wiosym_area_reproj_PointToRaster"
        with arcpy.EnvManager(cellSize=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\grid\grid\v01\grid_1km_v01.1.tif", outputCoordinateSystem="PROJCS["WGS_1984_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cylindrical_Equal_Area"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",12.0],PARAMETER["standard_parallel_1",-12.0],UNIT["Meter",1.0]]", snapRaster="grid_1km_v01.1.tif"):
            arcpy.conversion.PointToRaster(in_features=plastic_point_metric_ton_y_shp, value_field="dots_exten", out_rasterdataset=Meijer2021_midpoint_emission_clip_wiosym_area_reproj_PointToRaster, cell_assignment="SUM", priority_field="dots_exten", cellsize="\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\grid\\grid\\v01\\grid_1km_v01.1.tif", build_rat="BUILD")

        # Process: Focal Statistics (4) (Focal Statistics) (ia)
        plastic_focal_5_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\plastic_focal_5.tif"
        Focal_Statistics_4_ = plastic_focal_5_tif
        with arcpy.EnvManager(cellSize=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\grid\grid\v01\grid_1km_v01.1.tif", mask="grid_1km_v01.1.tif", outputCoordinateSystem="PROJCS["WGS_1984_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cylindrical_Equal_Area"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",12.0],PARAMETER["standard_parallel_1",-12.0],UNIT["Meter",1.0]]", 
                              snapRaster="grid_1km_v01.1.tif"):
            plastic_focal_5_tif = arcpy.ia.FocalStatistics(in_raster=Meijer2021_midpoint_emission_clip_wiosym_area_reproj_PointToRaster, neighborhood="Circle 5 CELL", statistics_type="SUM", ignore_nodata="DATA", percentile_value=90)
            plastic_focal_5_tif.save(Focal_Statistics_4_)


        # Process: Raster Calculator (6) (Raster Calculator) (ia)
        grid0_tif = "\\\\sgu.se\\SGU\\prod\\proj\\marin\\swoc\\work\\wiosym\\data\\reg\\pres\\pol_plastic\\v01\\proc\\grid0.tif"
        Raster_Calculator_6_ = grid0_tif
        with arcpy.EnvManager(cellSize=r"\\sgu.se\SGU\prod\proj\marin\swoc\work\wiosym\data\reg\grid\grid\v01\grid_1km_v01.1.tif", mask="grid_1km_v01.1.tif", outputCoordinateSystem="PROJCS["WGS_1984_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cylindrical_Equal_Area"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",12.0],PARAMETER["standard_parallel_1",-12.0],UNIT["Meter",1.0]]", 
                              snapRaster="grid_1km_v01.1.tif"):
            grid0_tif =  grid_1km_v01_1_tif *0
            grid0_tif.save(Raster_Calculator_6_)


        # Process: Mosaic To New Raster (2) (Mosaic To New Raster) (management)
        plastic_v2_tif = arcpy.management.MosaicToNewRaster(input_rasters=[plastic_focal_5_tif, grid0_tif], output_location=v01, raster_dataset_name_with_extension="plastic_v2.tif", coordinate_system_for_the_raster="PROJCS[\"WGS_1984_Cylindrical_Equal_Area\",GEOGCS[\"GCS_WGS_1984\",DATUM[\"D_WGS_1984\",SPHEROID[\"WGS_1984\",6378137.0,298.257223563]],PRIMEM[\"Greenwich\",0.0],UNIT[\"Degree\",0.0174532925199433]],PROJECTION[\"Cylindrical_Equal_Area\"],PARAMETER[\"false_easting\",0.0],PARAMETER[\"false_northing\",0.0],PARAMETER[\"central_meridian\",12.0],PARAMETER[\"standard_parallel_1\",-12.0],UNIT[\"Meter\",1.0]]", pixel_type="32_BIT_FLOAT", cellsize=None, number_of_bands=1, mosaic_method="SUM", mosaic_colormap_mode="FIRST")[0]
        plastic_v2_tif = arcpy.Raster(plastic_v2_tif)
