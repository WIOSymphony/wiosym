...
(sourcesym <-  read_tsv(paste(dest_path, "bathymetry_mean_m_1km_v01.1.tif_sourcesym.txt", sep="")))
```
...
depth_1km <- raster(paste(dest_path, "bathymetry_mean_m_1km_v01.1.tif", sep=""))
#plot(depth_1km)
```
...
outdata_path <- paste(work_path, "grid_250m_na_mean_depth_tid_gebco2021.tif", sep= "")
...
plot(r)
outdata_path <- paste(work_path, "grid_250m_na_mean_depth_tid_gebco2021_lzw.tif", sep= "")
...
r_temp_0 <- grid_1km_0
outdata_path <- paste(work_path, "grid_1km_na_mean_depth_tid_gebco2021.tif", sep= "")
writeRaster(r_temp_0, outdata_path,  overwrite=T, COMPRESS=LZW)
...
(r <- raster(outdata_path))
plot(r)
outdata_path <- paste(work_path, "grid_1km_na_mean_depth_tid_gebco2021_lzw.tif", sep= "")
writeRaster(r, output_path, overwrite=T, datatype = 'FLT4S', COMPRESS=LZW)
r <- raster(output_path)
...
dir(dest_path)
product_orig1 <- "bathymetry_mean_m_1km_v01.1.tif" 
product_orig2 <- "bathymetry_mean_m_250m_v01.1.tif"
...
print(script_name_copy <- paste(proc_log_path, gsub(".Rmd", "", script_name), d_version, ".Rmd", sep="")) # script name
```
