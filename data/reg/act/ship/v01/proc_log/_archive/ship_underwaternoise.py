# -*- coding: utf-8 -*-
"""
Generated by ArcGIS ModelBuilder on : 2022-06-19 10:02:44
"""
import arcpy
...
def ship_underwaternoise():  # ship_underwaternoise
    ...
    with arcpy.EnvManager(scratchWorkspace=r"M:\marin\swoc\work\wiosym\data\reg\act\ship\v01\proc\ship\Default.gdb", workspace=r"M:\marin\swoc\work\wiosym\data\reg\act\ship\v01\proc\ship\Default.gdb"):
        ...
        underwater_noise_norm_v01_1_tif = "M:\\marin\\swoc\\work\\wiosym\\data\\reg\\act\\ship\\v01\\underwater_noise_norm_v01.1.tif"
        Raster_Calculator_2_ = underwater_noise_norm_v01_1_tif
        with arcpy.EnvManager(cellSize=r"M:\marin\swoc\work\wiosym\data\reg\grid\grid\v01\grid_1km_v01.1.tif", mask="grid_1km_v01.1.tif", outputCoordinateSystem="PROJCS["WGS_1984_Cylindrical_Equal_Area",GEOGCS["GCS_WGS_1984",DATUM["D_WGS_1984",SPHEROID["WGS_1984",6378137.0,298.257223563]],PRIMEM["Greenwich",0.0],UNIT["Degree",0.0174532925199433]],PROJECTION["Cylindrical_Equal_Area"],PARAMETER["false_easting",0.0],PARAMETER["false_northing",0.0],PARAMETER["central_meridian",12.0],PARAMETER["standard_parallel_1",-12.0],UNIT["Meter",1.0]]", 
                              scratchWorkspace=r"M:\marin\swoc\work\wiosym\data\reg\act\ship\v01\proc\ship\Default.gdb", snapRaster="grid_1km_v01.1.tif", workspace=r"M:\marin\swoc\work\wiosym\data\reg\act\ship\v01\proc\ship\Default.gdb"):
            underwater_noise_norm_v01_1_tif =  ((commer_combinr_grid_tif - commer_combinr_grid_tif.minimum)/(commer_combinr_grid_tif.maximum-commer_combinr_grid_tif.minimum))*100
            underwater_noise_norm_v01_1_tif.save(Raster_Calculator_2_)
