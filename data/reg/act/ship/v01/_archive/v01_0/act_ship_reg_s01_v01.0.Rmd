...
stack <- ship_stack
stack <- crop(ship_stack, extent_box)
...
## turn AIS into noise disturbance
...
a <- matrix(1/9801, nc=99, nr=99)
r5 <- focal(r, w=matrix(1/25,nrow=5,ncol=5)) 

r_focal_100km <- focal(noise_com, a, na.rm=F) 
...
#r_focal_50km <- focal(noise_com, w, na.rm=T) 
...
r <- stack[[4]] # going only with "global layer here..., more thinking needed
w <- focalWeight(r, 2000, "Gauss") # simulating spread of disturbance
r_focal_2km <- focal(r, w, na.rm=T) 
