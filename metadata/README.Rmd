...
eco$raw_link <- raw
eco$source <- "[Source 1 name](https://google.com), [Source 2 name](https://google.com), etc"
...
pres$raw_link <- raw
pres$source <- "[Source 1 name](https://google.com), [Source 2 name](https://google.com), etc"
