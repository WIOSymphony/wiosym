...
```{r}
# Files
source2_path <- path <- paste(source_dir, "REPLACE.ext", sep="")
object_name <- st_read(path) # REPLACE object_name
# add files from dir as needed
```
# Data_raw DIR...: # keep adding data_raw sources by copying above
...
*****************************************************************
## NOTE 1. Normalisation will happen at later "final" stage, do not integrate in main scripts
## NOTE 2. Create the uncertainty map separate (script *_s02_v01) once main data is ready (script *_s01_v01)
*****************************************************************
