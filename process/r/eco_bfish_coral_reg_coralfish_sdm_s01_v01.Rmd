...
#spec <- occurrence(taxonid = 125562,
#                   #scientificname = "",
...
d
m1 <- sdm(Occurrence~.,data=d,methods=c('brt','svm')) #'brt','glm','svm','gam'
m1
...
# Assign values to coral reef cells
```{r}
coral <- raster(paste0(work1_path, "/coral_reef_proportion_1km_v01.1.tif"))
coral[coral > 0] <- 1
eco <- product1
eco <- eco*coral
