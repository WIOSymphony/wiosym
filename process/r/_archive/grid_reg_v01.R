...
# Now, make sure to save a copy of the R script here (if you update the files, make sure to update this script to):

# mirror your R script here:
dest1_path_script <- paste(proc1_path, theme1, "_", subtheme1,"_", version, d_version, ".R", sep="")
dest1_path_script



# Final check  ----------------------------------------------------------------------------------
# Do a final check on the products and doublecheck sourcesym file exists and are complete for all files in root
