...
location = "reg"   #check
theme1 <- "eco"   #check
subtheme1 <- "bh_coral"   #check
name1 <- "coral_sdm"   #check
name2 <- "" #check
...
spec <- occurrence(taxonid = 1340, geometry = "POLYGON ((86.66016 23.88584, 89.12109 -47.27923,
...
#spec_sp <- SpatialPointsDataFrame(coords = xy, data = spec, proj4string = crs(grid_1km))
