...
theme1 <- "eco"   #check
subtheme1 <- "inv"   #check
name1 <- "inv_epifauna_sdm"   #check
name2 <- "Echinoidea" #check
...
spec <- occurrence(taxonid = 123082,
                   #scientificname = "",
...
d
m1 <- sdm(Occurrence~.,data=d,methods=c('brt','svm','gam','glm')) 
m1
...
```{r}
#base <- grid_1km - 1
eco1 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Asteroidea_v01.0.tif")
eco2 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Brachyura_v01.0.tif")
eco3 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Dendrobranchiata_v01.0.tif")
eco4 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Echinoidea_v01.0.tif")
eco5 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Holothuroidea_v01.0.tif")
eco6 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Nephropidae_v01.0.tif")
eco7 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Octopoda_v01.0.tif")
eco8 <- raster("./data/reg/eco/inv/inv_epifauna_sdm/v01/inv_inv_epifauna_sdm_Sepiida_v01.0.tif")

#eco1[eco1<0.7] <- 0
#eco2[eco2<0.7] <- 0
#eco3[eco3<0.7] <- 0

eco <- eco1+eco2+eco3+eco4+eco5+eco6+eco7+eco8
product1 <- eco
