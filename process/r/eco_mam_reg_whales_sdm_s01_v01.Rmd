...
```{r}
# base <- grid_1km - 1
eco.threat <- raster("./data/glo/eco/mam/whales_sdm/v01/mam_whales_sdm_threatened_v01.0.tif")
eco.all <- raster("./data/glo/eco/mam/whales_sdm/v01/mam_whales_sdm_all_v01.0.tif")
# 
# eco.threat <- (eco.threat + 1)*10
# eco.all[eco.all < 0.99] <- 0
# 
