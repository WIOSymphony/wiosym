...
#File 2 ...
source_file <- "internalfolder/someotherdata.ext" # your data file(s)
source_path <- paste(source_dir, source_file, sep="")
source_path
source1_object2 <- read(source_path)
source1_object2

# Read data from source directory 2 ...
# source2_dir <- ...
...
# data1: watermask
data1_dir <- data_dir <-  "./data/location/theme/subtheme/vxx/"  # input your data directory
dir(data_dir) # check what data is in this directory
data_file <- "somedata.ext" # your data file
...
data_path
data1_object <- raster(data_path) # read in your data object if appropriate and perhaps change name to more informative...


# data2: ... # add same information as data1 example above for all source files used
# data2_dir <- ...
# ...
...
subtheme1 <- subtheme <- "subtheme" # input your subtheme based on the most appropriate option from the list. If your subtheme is missing, please add new subtheme to folders.txt first (and make sure to sync with shared location for WIOSym if applicable)
