...
name2 <- "Procellaria_aequinoctialis" #check
...
# This layer combines ensemble models for three species: Diomedea exulans, Phoebetria fusca, Procellaria aequinoctialis
...
spec <- occurrence(#taxonid = 2686,
                   scientificname = sub("_", " ", name2), # Specify species in name2 variable above
...
# Write individual species model to file
```{r}
...
```{r}
eco1 <- raster("./data/reg/eco/bird_sea/seabirds_sdm/v01/bird_sea_seabirds_sdm_Diomedea_exulans_v01.0.tif")
eco2 <- raster("./data/reg/eco/bird_sea/seabirds_sdm/v01/bird_sea_seabirds_sdm_Phoebetria_fusca_v01.0.tif")
eco3 <- raster("./data/reg/eco/bird_sea/seabirds_sdm/v01/bird_sea_seabirds_sdm_Procellaria_aequinoctialis_v01.0.tif")
